...
- **人脸识别**：自动检测照片中的人脸，按相似度聚类为不同人物，用户可命名和浏览
...
| 图片处理 | sharp |
| 人脸识别 | @vladmandic/face-api (WASM 后端) |
| EXIF 读取 | exifr |
...
- `photos.json` — 照片索引（路径、日期、缩略图状态、人脸数据、人物列表）
